...
def get_cli_command_runner(dnac_jwt_token):
    """
...
def get_content_file_id(file_id, dnac_jwt_token):
    """
    This function will donwload a file specified by the {file_id}
...
def get_output_command_runner(command, device_name, dnac_jwt_token):
    ...
    # get task id status after 2 sec. delay to allow task to be completed
    time.sleep(2)
